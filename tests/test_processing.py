...
##############
@pytest.mark.parametrize('test_list, state, expected_list', [
    (listing1, 'CANCELED', [
        {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
        {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'}]),
    (listing1, 'EXECUTED', [
...
##############
@pytest.mark.parametrize('test_list, sorting, expected', [
    (listing1, False, [{'id': 615064544, 'state': 'ASD', 'date': '2017-10-14T08:21:33.419441'},
                      {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
                      {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
                      {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
                      {'id': 615064591, 'state': 'ASD', 'date': '2018-11-14T08:21:33.419441'},
...
##############
@pytest.mark.parametrize('test_list, sorting, expected', [
    (listing1, True, [{'id': 41428829, 'state': 'EXECUTED', 'date': '2019-07-03T18:35:29.512364'},
                       {'id': 615064591, 'state': 'ASD', 'date': '2018-11-14T08:21:33.419441'},
                       {'id': 615064591, 'state': 'CANCELED', 'date': '2018-10-14T08:21:33.419441'},
                       {'id': 594226727, 'state': 'CANCELED', 'date': '2018-09-12T21:27:25.241689'},
                       {'id': 939719570, 'state': 'EXECUTED', 'date': '2018-06-30T02:08:58.425572'},
...
##############
@pytest.mark.parametrize('test_list, sorting, expected', [
    (listing3, True, [{'id': 615064591, 'state': 'ASD', 'date': '2018-11-14T08:21:33.419441'},
